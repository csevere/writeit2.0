  ...
  render() {
    ...
    return <div className = "app">
      ...
      <form className="form-group">
        <label for="note-add">Write New Note</label>
        <input 
          id="note-add" 
          ...
          />
        <label for="select-color">Choose Color</label>
        <div id="select-color">
        ...
        <button className="btn btn-success" onClick={this.handleAddNote.bind(this)}>Create Note</button>
