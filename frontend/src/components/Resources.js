					...
					<Container className = "res-wrapper mt-5 pt-5">
						<Row className = "no gutters">
							<Col sm = "9" className = "m-auto">
								<Col sm = "2" className = "m-auto res-icon">
									<img src="img/resources.png" alt="" className = "img-fluid rounded-circle" />
								</Col>
								<div>
									<h1 className = "text-center">RESOURCES</h1>
									<p className = "text-center tagline">Browse through some of these nifty and helpful resources for writers of all levels.</p>
									<hr id="resource-line" />
								</div>
								<Table class="resources-table" bordered responsive>
									<thead>
									<tr>
										<th className = "text-center header">Book</th>
										<th className = "text-center header">Title & Author</th>
										<th className = "text-center header">Description</th>
									</tr>
									</thead>
									<tbody>
									<tr>
